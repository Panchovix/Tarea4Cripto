...
with open("C:\\Users\\Pancho\\Desktop\\Tarea 4 cripto\\Hasheo nuevo\\crackeado3d2plain.txt") as e, open("output3.txt", "w") as f:
    for line in e:
...
with open('outencrypted3.txt', 'w') as f:
    with redirect_stdout(f):
