...
with open("C:\\Users\\Pancho\\Desktop\\Tarea 4 cripto\\Hasheo nuevo\\crackeado5d2plain.txt") as e, open("output5.txt", "w") as f:
    for line in e:
...
with open('outencrypted5.txt', 'w') as f:
    with redirect_stdout(f):
