...
with open("C:\\Users\\Pancho\\Desktop\\Tarea 4 cripto\\Hasheo nuevo\\crackeado2d2plain.txt") as e, open("output2.txt", "w") as f:
    for line in e:
...
with open('outencrypted2.txt', 'w') as f:
    with redirect_stdout(f):
